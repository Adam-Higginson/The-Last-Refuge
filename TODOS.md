...
4. **Crew event log in detail panel** — Timeline of significant events per crew member (transferred, appointed, morale shifts, relationship changes). Builds on backstory as living narrative. Effort: L, Priority: P3. Blocked by: event system + dynamic relationships.
