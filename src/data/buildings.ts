...
export const BUILDING_TYPES: Record<BuildingId, BuildingType> = {
    ...
    farm: {
        ...
        effects: [
            { type: 'production', resource: 'food', amount: 10 },
        ],
        description: 'Produces 10 Food/turn. Requires 2 Civilians.',
        gridWidth: 3,
        gridHeight: 3,
    },
    solar_array: {
    ...
    hydroponics_bay: {
        ...
        workers: { role: 'Engineer', count: 1 },
        effects: [
            { type: 'production', resource: 'food', amount: 15 },
        ],
        description: 'Produces 15 Food/turn. Energy-hungry. Requires 1 Engineer.',
        gridWidth: 3,
        gridHeight: 3,
    },
};
