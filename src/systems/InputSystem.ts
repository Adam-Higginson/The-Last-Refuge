...
export class InputSystem extends System {
    ...
    private pendingRightClick: { x: number; y: number; shiftKey: boolean } | null = null;
    ...
    init(world: World): void {
        ...
        this.onContextMenu = (e: MouseEvent): void => {
            e.preventDefault();
            this.pendingRightClick = { x: e.clientX, y: e.clientY, shiftKey: e.shiftKey };
        };
    ...
    update(_dt: number): void {
        ...
        if (this.pendingRightClick) {
            ...
            if (!rightClickedEntity) {
                if (this.pendingRightClick.shiftKey) {
                    this.eventQueue.emit({
                        type: GameEvents.SHIFT_RIGHT_CLICK,
                        x: worldClick.x,
                        y: worldClick.y,
                    });
                } else {
